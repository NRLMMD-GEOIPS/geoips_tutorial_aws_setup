...
setup_user_env() {
    ...
    local jupyter_config_dir="${user_home}/.jupyter"
    local custom_css_dir="${jupyter_config_dir}/custom"
    ...
    install -d -m 755 -o "${user}" -g "${user}" \
        "${jupyter_config_dir}" "${custom_css_dir}"
